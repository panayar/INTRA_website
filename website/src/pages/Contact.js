    ...
    <div className="row">
      ...
      <div className="col-12">
        <Accordion
          ...
          titleOne={
            dataPage.ContactAccordion[0].sections[0].firstQuestion[0].title
          }
          descriptionOne={
            dataPage.ContactAccordion[0].sections[0].firstQuestion[0]
              .description
          }
          titleTwo={
            dataPage.ContactAccordion[0].sections[0].secondQuestion[0].title
          }
          descriptionTwo={
            dataPage.ContactAccordion[0].sections[0].secondQuestion[0]
              .description
          }
          titleThree={
            dataPage.ContactAccordion[0].sections[0].thirdQuestion[0].title
          }
          descriptionThree={
            dataPage.ContactAccordion[0].sections[0].thirdQuestion[0]
              .description
          }
        />
      </div>
