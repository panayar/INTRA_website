    ...
    <div className="row">
      ...
      <div className="col-12">
        <Accordion
          ...
          titleOne={
            dataPage.SupportAccordion[0].sections[0].firstQuestion[0].title
          }
          descriptionOne={
            dataPage.SupportAccordion[0].sections[0].firstQuestion[0]
              .description
          }
          titleTwo={
            dataPage.SupportAccordion[0].sections[0].secondQuestion[0].title
          }
          descriptionTwo={
            dataPage.SupportAccordion[0].sections[0].secondQuestion[0]
              .description
          }
          titleThree={
            dataPage.SupportAccordion[0].sections[0].thirdQuestion[0].title
          }
          descriptionThree={
            dataPage.SupportAccordion[0].sections[0].thirdQuestion[0]
              .description
          }
        />
      </div>
